...
>[!NOTE]
> Enabling <code>FPS_Dip_Reload</code> on fast or medium bounce speed ammos actually makes your last shot ~51ms slower than if you assumed you needed a reload. What this means is that if you don't spare-shot on the last shot, having this option enabled actually makes your LLBG slower. Another thing to note about this option is that when your framerate is released it is set back to the in games "No Limit" option (300fps).
